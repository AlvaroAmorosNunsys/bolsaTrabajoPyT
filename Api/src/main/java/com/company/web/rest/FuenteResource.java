...
/**
 * REST controller for managing {@link com.company.domain.Fuente}.
 */
@RestController
@RequestMapping("/api")
public class FuenteResource {
    ...
    public ResponseEntity<FuenteDTO> updateFuente(@Valid @RequestBody FuenteDTO fuenteDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fuenteDTO.getId().toString()))
            .body(result);
    }
