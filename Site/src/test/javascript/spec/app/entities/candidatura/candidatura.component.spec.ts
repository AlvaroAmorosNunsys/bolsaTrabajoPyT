...
import { CandidaturaComponent } from 'app/entities/candidatura/candidatura.component';
...
describe('Component Tests', () => {
  describe('Candidatura Management Component', () => {
    let comp: CandidaturaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CandidaturaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.candidaturas && comp.candidaturas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
