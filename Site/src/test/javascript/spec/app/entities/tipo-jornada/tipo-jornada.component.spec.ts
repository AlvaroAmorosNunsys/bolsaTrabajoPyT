...
import { TipoJornadaComponent } from 'app/entities/tipo-jornada/tipo-jornada.component';
...
describe('Component Tests', () => {
  describe('TipoJornada Management Component', () => {
    let comp: TipoJornadaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TipoJornadaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tipoJornadas && comp.tipoJornadas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
